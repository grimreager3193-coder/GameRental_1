...
// ---- หมวดหมู่ (ชื่อตารางจริง = game_categories) ----
...
<section class="section">
  <h2 class="section-title">🔥 โปรโมชันตอนนี้</h2>
...
<section class="section">
  <h2 class="section-title">🎮 คลังเกมให้เช่า</h2>
  ...
  <form class="filter-bar" method="get" action="<?= BASE_URL ?>/index.php">
    ...
    <?php if ($cat_id || $keyword !== ''): ?>
      <a class="btn btn-ghost" href="<?= BASE_URL ?>/index.php">ล้างตัวกรอง</a>
    <?php endif; ?>
  </form>
